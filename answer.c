...
void main(void)
{
  ...
  /*.......答题区1开始：LED灯IO端口初始化....................*/
  P1SEL &= ~0x1F;//设置P1_0至P1_4为GPIO口
  P1DIR |= 0x1B;//设置P1_0、P1_1、P1_3、P1_4为输出
  D3=D4=D5=D6=0;//熄灭所有LED灯
  /*.......答题区1结束.......................................*/
  ...
  /*.......答题区4开始：LED灯工作模式.........................*/
    ...
    {
    case 1:
      D3=D4=D5=D6=0;//设置D3、D4、D5、D6全部熄灭
      break;
    case 2:
      D3=D4=D5=D6=0;//设置D3、D4、D5、D6全部闪烁显示
      delay();
      D3=D4=D5=D6=1;
      delay();
      break;
    case 3:
      D3=D4=0;//设置D3、D4熄灭，D5、D6交替闪烁
      D5=1;
      D6=0;
      delay();
      D5=0;
...
__interrupt void T1_ISR(void)
{
  ...
  if(counter>10)
  {
      /*.......答题区6开始：...........*/
    T1CTL &= ~0x01;//定时器1暂停运行
    T1CNTL = 1;//设置T1CNTL清零定时器1计数寄存器
    LedState = keyCount;//设置LED灯工作模式等于按键次数
     /*.......答题区6结束...........*/
